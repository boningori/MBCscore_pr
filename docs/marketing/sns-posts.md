...
```
ミニバス専用デジタルスコアシート「MBCscore」公式🏀 フリック入力で試合を見ながら高速記録、JBA準拠スコアシートを自動生成。オフライン対応で電波の悪い体育館でもOK。完全無料・登録不要・インストール不要、ブラウザで開くだけ。スコアラー担当のパパ・ママ・コーチを応援します！
```
...
```
ミニバス専用の無料デジタルスコアシート「MBCscore」。フリック入力で高速記録、JBA準拠シートを自動生成、オフライン対応。インストール不要でブラウザからすぐ使えます。
```
...
・JBA準拠スコアシート: 試合記録から公式様式を自動生成し、PDF/画像で共有できます
